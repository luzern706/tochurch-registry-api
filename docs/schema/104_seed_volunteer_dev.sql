-- ============================================================
-- 104_seed_volunteer_dev.sql
-- dev 서버용 — church_id=19715 (행복샘교회 2). local 버전은 104_seed_volunteer.sql(church_id=33632) 참고.
-- 봉사 관리 (reg_service_teams, reg_service_members) 테스트 데이터
--
-- 대상 church_id : 19715
-- 사용 교인 ID   : 4 ~ 35 (reg_members 기존 등록 교인, 101_seed_registry_full.sql 선행 필요 — @church_id=19715로 적재된 상태여야 함)
--
-- 커버하는 화면/상태 시나리오
...
-- ------------------------------------------------------------
-- DELETE FROM reg_service_members WHERE service_team_id IN (SELECT id FROM reg_service_teams WHERE church_id = 19715);
-- DELETE FROM reg_service_teams WHERE church_id = 19715;
...
VALUES
(1, 19715, '주일 주차 안내',     '주일 예배 시간에 교회 주차장 안내를 도와주세요',   'parking', 'regular', 'weekly',   0, '08:30:00', NULL,         NULL,       NULL,       6,  8,  'assignment',  1),
(2, 19715, '찬양대 반주',         '주일 예배 찬양대 반주 봉사',                        'worship', 'regular', 'weekly',   0, '10:00:00', NULL,         NULL,       NULL,       2,  5,  'application', 1),
(3, 19715, '주일 환경 정리',     '예배 후 본당·로비 환경 정리',                       'worship', 'regular', 'weekly',   0, '13:00:00', NULL,         NULL,       NULL,       3,  9,  'assignment',  1),
(4, 19715, '어린이부 간식 준비', '유초등부 예배 간식 준비 및 배분',                   'dining',  'regular', 'weekly',   0, '09:00:00', NULL,         NULL,       NULL,       4,  14, 'application', 1),
(5, 19715, '부활절 특송팀',       '부활절 연합예배 특별 찬양 준비',                   'special', 'onetime', NULL,       NULL, NULL,     '2026-04-05', '10:00:00', '11:30:00', 8,  10, 'assignment',  1),
(6, 19715, '겨울수련회 준비',     '겨울 수련회 준비 및 진행 지원',                     'event',   'onetime', NULL,       NULL, NULL,     '2026-01-20', '09:00:00', '18:00:00', 10, 11, 'application', 1),
(7, 19715, '주일학교 교사',       '유초등부 주일학교 반 교사',                         'worship', 'regular', 'weekly',   0, '09:30:00', NULL,         NULL,       NULL,       5,  15, 'assignment',  1),
(8, 19715, '여름 수련회 준비',     '2025년 여름 수련회 준비 (종료)',                   'event',   'onetime', NULL,       NULL, NULL,     '2025-08-01', '09:00:00', '17:00:00', 6,  12, 'application', 0);
